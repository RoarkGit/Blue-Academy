---
title: Masked Carnivale Bonuses Guide
date: 2026-05-16
weight: 20
patch: '7.5'
description: >-
  Masked Carnivale bonus descriptions: additional challenges and
...
: Completed performance faster than the ideal time.

**Slow and Steady**  
: Complete performance faster than the standard time.

**10 Ways to Die**  
: Used between two and ten unique spell types.
...
**Total Mastery**  
: Used actions aspected to all six elements and three damage types (blunt,
piercing, slashing).
...
This one is <b>extremely</b> strict. All BLU actions that you use must
...
**Beginner Spellcasting**  
: Cast only rank 1 or 2 spells. _Note: This is the "star rating" associated with
each spell._
