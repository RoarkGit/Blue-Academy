...
and wipe the group. We handle this by assigning three DPS to sprint and jump
through them such that they each blow up two regulators. They will die and need
to be resurrected, but then Royal Pentacle is done. See below for what that
looks like:
